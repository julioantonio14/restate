...
export const FeaturedCard = ({ onPress }: Props) => {
    return (
        <TouchableOpacity onPress={onPress} className='flex flex-col items-start w-60 h-80 relative'>
            ...
            <View className='flex fle-col items-start absolute bottom-5 inset-x-5'>
                <Text className='text-xl font-rubik-extrabold text-white' numberOfLines={1}>Modern Apartment</Text>
                <Text className='text-base font-rubik text-white'>22 W 15th, new York</Text>
...
export const Card = ({ onPress }: Props) => {
    return (
        <TouchableOpacity onPress={onPress} className='flex-1 w-full mt-4 px-3 py-4 rounded-lg bg-white shadow-lg shadow-black-100/70 relative'>
            <View className='flex flex-row items-center absolute px-2 top-5 right-5 bg-white/90 p-1 rounded-full z-500'>
            ...
            <View className='flex fle-col mt-2'>
                <Text className='text-base font-rubik-bold text-black-300'>Cozy Studio</Text>
                <Text className='text-xs font-rubik text-black-200'>22 W 15th, new York</Text>
